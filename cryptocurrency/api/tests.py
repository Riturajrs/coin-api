...
class MarketDataForCoinTest(APITestCase):
    ...
    def test_market_data_for_coin_with_id_and_category(self, mock_get):
        ...
        response = self.client.get(self.url, {'page_num': 1, 'per_page': 2, 'id': 'bitcoin', 'category': 'cryptocurrency'})
    ...
    def test_market_data_for_coin_with_id_only(self, mock_get):
        ...
        response = self.client.get(self.url, {'page_num': 1, 'per_page': 1, 'id': 'bitcoin'})
    ...
    def test_market_data_for_coin_with_category_only(self, mock_get):
        ...
        response = self.client.get(self.url, {'page_num': 1, 'per_page': 1, 'category': 'cryptocurrency'})
    ...
    def test_market_data_for_coin_pagination(self, mock_get):
        ...
        response = self.client.get(self.url, {'page_num': 2, 'per_page': 2, 'category': 'cryptocurrency'})
    ...
    def test_market_data_for_coin_error(self, mock_get):
        mock_get.return_value.status_code = 500
        mock_get.return_value.raise_for_status.side_effect = requests.exceptions.RequestException("Test error")
